...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "apmzpaj3vq8zmw5xyuy3kttqutj01d5gufnsxv7690826s8n9v5h",
   ...
   viewInfo = (
     ...
     # https://github.com/sandstorm-io/sandstorm/blob/master/src/sandstorm/grain.capnp
       (
         ...
         description = (defaultText = "grants ability to add and modify translations"),
         # Prose describing what this role means, suitable for a tool tip or similar help text.
       ),
       (
         name = "editProject"
         title = (defaultText = "edit project"),
         description = (defaultText = "grants ability to edit project settings")
       )
     ],
     roles = [
       # Roles are logical collections of permissions.  For instance, your app may have
       # a "guest" role and an "admin" role
       (
         ...
         verbPhrase = (defaultText = "can do everything the owner can do"),
         # Brief explanatory text to show in the sharing UI indicating
         # what a user assigned this role will be able to do with the grain.

         description = (defaultText = "admins have the same permissions as the owner / creator."),
         # Prose describing what this role means, suitable for a tool tip or similar help text.
       ),
       (
         title = (defaultText = "editor"),
         permissions = [true, false],
         verbPhrase = (defaultText = "can add and modify translations")
         description = (defaultText = "editors may view / add / modify all translations."),
       )
       (
         title = (defaultText = "guest"),
         permissions  = [false, false],
         verbPhrase = (defaultText = "can only view the translations"),
         description = (defaultText = "guests may view what other users have written."),
       ),
     ],
   ),
   #apiPath = "/api",
