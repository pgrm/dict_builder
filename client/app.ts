...
import {Component, View, NgFor, NgIf, provide} from 'angular2/angular2';
...
import {ProjectsSideList} from 'client/project-components/projects-side-list';
...
@View({
  ...
  directives: [RouterOutlet, RouterLink, AccountsUI, GravatarDirective, ProjectsSideList]
})
@RouteConfig([
